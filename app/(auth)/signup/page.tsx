                ...
                >
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2.5 bg-black hover:bg-neutral-800 text-white font-semibold py-2.5 rounded-2xl transition-colors text-sm shadow-sm cursor-pointer"
                    >
